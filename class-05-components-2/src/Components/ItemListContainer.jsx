...
const ItemListContainer = () => {
    ...
    const products = [
        ...
        {name: 'polerones', price: 400, description: 'item description'},
        ...
        {name: 'helados', price: 1000, description: 'item description'},
        {name: 'ampolletas', price: 1100, description: 'item description'},
